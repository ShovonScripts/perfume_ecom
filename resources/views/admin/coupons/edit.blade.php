...
<div class="max-w-2xl">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border dark:border-gray-700 p-6">
        <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-6">Edit Coupon: {{ $coupon->code }}</h2>
        ...
        <form action="{{ route('admin.coupons.update', $coupon) }}" method="POST">
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <input type="number" name="min_subtotal" id="min_subtotal" value="{{ old('min_subtotal', $coupon->min_subtotal) }}" step="0.01" min="0"
                           class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="ends_at" id="ends_at" value="{{ old('ends_at', $coupon->ends_at?->format('Y-m-d')) }}"
                               class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    </div>
                </div>
                ...
                <div>
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="is_active" {{ old('is_active', $coupon->is_active) ? 'checked' : '' }}
