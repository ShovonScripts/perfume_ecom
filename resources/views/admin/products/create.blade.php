...
<div class="max-w-3xl">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border dark:border-gray-700 p-6">
        <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-6">Create New Product</h2>
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <textarea name="short_description" id="short_description" rows="2"
                              class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent">{{ old('short_description') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="long_description" id="long_description" rows="6"
                              class="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent">{{ old('long_description') }}</textarea>
                ...
                <div class="border-t dark:border-gray-700 pt-5">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Thumbnail Image</label>
                            <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-4 text-center hover:border-indigo-500 transition">
                                ...
                                <p class="text-xs text-gray-400 mt-2">PNG, JPG, WEBP up to 2MB</p>
                                <img id="thumbnail-preview" class="mt-3 mx-auto max-h-32 rounded-lg hidden">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-4 text-center hover:border-purple-500 transition">
                                ...
                                <p class="text-xs text-gray-400 mt-2">Multiple images allowed</p>
                ...
                <!-- Variants (Alpine.js) -->
                <div class="border-t dark:border-gray-700 pt-5" x-data="variantManager()">
