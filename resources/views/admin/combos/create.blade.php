...
<div class="max-w-4xl" x-data="comboManager()">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border dark:border-gray-700 p-6">
        <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-6">Create New Combo</h2>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3" class="w-full px-4 py-2 border rounded-xl dark:bg-gray-700 dark:border-gray-600 dark:text-white"></textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="sort_order" value="0" class="w-full px-4 py-2 border rounded-xl dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                        </div>
